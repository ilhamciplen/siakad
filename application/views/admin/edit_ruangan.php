        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="myForm" action="<?php echo site_url('admin/update_ruangan') ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="row">
                  <div class="col-5">
                    <label>Kode Ruangan</label>
                    <input type="text" class="form-control"  placeholder="Isi Kode Ruangan" name="kode_ruangan" value="<?php echo $ruangan->kode_ruangan ?>">
                  </div>
                  <div class="col-5">
                  <label>Kode Gedung</label>
                    <select required name="gedung_kode" id="gedung_kode" class="form-control">
                                                 <option value="<?php echo $ruangan->gedung_kode ?>"><?php echo $ruangan->gedung_kode ?></option>
                ...
                <div class="row">
                  <div class="col-5">
                    ...
                    <input type="text" class="form-control"  placeholder="Isi Nama Ruangan" name="nama_ruangan" value="<?php echo $ruangan->nama_ruangan ?>">
                  </div>
                  <div class="col-5">
                    <label>Kapasitas</label>
                    <input type="text" class="form-control"  placeholder="Isi Kapasitas Ruangan" name="kapasitas" value="<?php echo $ruangan->kapasitas ?>">
                  </div>
                </div>
            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <h3 class="timeline-header"><a href="#">Petunjuk Pengisian</a> Edit Ruangan</h3>

                  <div class="timeline-body">
                    1. Silahkan masukkan data yang ada<br>
                    2. Kode ruangan jangan diubah karena UNIQUE<br>
