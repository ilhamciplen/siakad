        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="myForm" action="<?php echo site_url('admin/save_guru') ?>" method="post" enctype="multipart/form-data">
              <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    <label>NIP</label>
                    <input required type="text" class="form-control"  placeholder="Isi NIP" name="nip" value="">
                  </div>
                  <div class="col-6">
                    <label>NIK</label>
                ...
                <div class="row">
                  ...
                  <label>Nama Guru</label>
                    <input required type="text" class="form-control"  placeholder="Isi Nama Guru" name="nama_guru" value="">
                  </div>
                  <div class="col-6">
                  <label>Agama</label>
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <label>Email</label>
                    <input required type="text" class="form-control"  placeholder="Isi Email" name="email" value="">
                  </div>
