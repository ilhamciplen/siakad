        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="myForm" action="<?php echo site_url('admin/save_jurusan') ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="row">
                  <div class="col-5">
                    <label>Kode Jurusan</label>
                    <input type="text" class="form-control"  placeholder="Isi Kode Jurusan" name="kode_jurusan" value="">
                  </div>
                  <div class="col-5">
                    <label>Nama Jurusan</label>
                    <input type="text" class="form-control"  placeholder="Isi Nama Jurusan" name="nama_jurusan" value="">
                  </div>
                </div>
            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <h3 class="timeline-header"><a href="#">Petunjuk Pengisian</a> Tambah Jurusan</h3>

                  <div class="timeline-body">
                    1. Silahkan Masukkan Kode Jurusan<br>
                    2. Silahkan Masukkan Nama Jurusan<br>
                  </div>
