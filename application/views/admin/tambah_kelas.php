        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="myForm" action="<?php echo site_url('admin/save_kelas') ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="row">
                  <div class="col-5">
                    <label>Kode Kelas</label>
                    <input type="text" class="form-control"  placeholder="Isi Kode Kelas" name="kode_kelas" value="">
                  </div>
                  <div class="col-5">
                ...
                <div class="row">
                  <div class="col-5">
                    ...
                    <input type="text" class="form-control"  placeholder="Isi Nama Kelas" name="nama_kelas" value="">
                  </div>
                  <div class="col-5">
                    <label>Jurusan</label>
            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <h3 class="timeline-header"><a href="#">Petunjuk Pengisian</a> Tambah Kelas</h3>

                  <div class="timeline-body">
                    1. Silahkan Masukkan Kode Kelas (X-AK1)<br>
