        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="myForm" action="<?php echo site_url('admin/save_kurikulum') ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="row">
                  <div class="col-5">
                    <label>Kode Kurikulum</label>
                    <input type="text" class="form-control"  placeholder="Isi Kode Kurikulum" name="kode_kurikulum" value="">
                  </div>
                  <div class="col-5">
                    <label>Nama Kurikulum</label>
                    <input type="text" class="form-control"  placeholder="Isi Nama Kurikulum" name="nama_kurikulum" value="">
                  </div>
                </div>
            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <h3 class="timeline-header"><a href="#">Petunjuk Pengisian</a> Tambah Kurikulum</h3>

                  <div class="timeline-body">
                    1. Silahkan Masukkan Kode Kurikulum<br>
                    2. Silahkan Masukkan Nama Kurikulum<br>
                  </div>
