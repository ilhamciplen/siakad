        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="myForm" action="<?php echo site_url('admin/save_mapel') ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="row">
                  <div class="col-5">
                    <label>Kode Mata Pelajaran</label>
                    <input required type="text" class="form-control"  placeholder="Isi Kode Mapel" name="kode_mapel" value="">
                  </div>
                  <div class="col-5">
                    <label>Nama Mata Pelajaran</label>
                    <input required type="text" class="form-control"  placeholder="Isi Nama Mapel" name="nama_mapel" value="">
                  </div>
                </div>
            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <h3 class="timeline-header"><a href="#">Petunjuk Pengisian</a> Tambah Mapel</h3>
