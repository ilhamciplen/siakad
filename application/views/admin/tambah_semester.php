        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="myForm" action="<?php echo site_url('admin/save_semester') ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="row">
                  <div class="col-5">
                    <label>Kode Semester</label>
                    <input type="text" class="form-control"  placeholder="Isi Kode Semester" name="kode_semester" value="">
                  </div>
                  <div class="col-5">
                    <label>Semester</label>
                    <input type="text" class="form-control"  placeholder="Isi Semester" name="nama_semester" value="">
                  </div>
                </div>
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    1. Silahkan Masukkan Kode Semester<br>
