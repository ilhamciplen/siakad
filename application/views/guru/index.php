    ...
    <div class="row">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    Anda Login Sebagai : <h3><b><font color="red">Guru</font></b></h3>
                  </div>
          ...
          <div class="timeline">
              ...
              <div class="card-body box-profile">
                ...
                <a href="<?php echo base_url("guru/edit_profil") ?>" class="btn btn-primary btn-block"><b>Edit Akun?</b></a>
                <a href="<?php echo base_url("guru/changepassword") ?>" class="btn btn-primary btn-block"><b>Ubah Password?</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
             ...
             <div>
                ...
                <div class="timeline-item">
                  <span class="time"><i class="fas fa-calendar"></i> <?php echo date('l, d M Y'); ?></span>
                  <h3 class="timeline-header"><a href="<?= site_url('guru/biodata') ?>">Biodata</a>(cek disini)</h3>
