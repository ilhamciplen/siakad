         ...
         <div class="row">
             <div class="col-12">
                 <div class="card card-info">
                     ...
                     <h5 class="text-center">Kelas Yang Anda Wakili</h5>
                     </div>
            ...
            <tbody>
                ...
                foreach ($kelas as $row){
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="<?= base_url('guru/detail_kelas') . '/' . $row->kode_kelas; ?>" class="btn btn-success btn-sm">Detail Kelas</a>
                        </td>
                    </tr>
                <?php }
              } ?>
