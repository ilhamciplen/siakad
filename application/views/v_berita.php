...
<!-- end header -->
<section id="lomba" class="section padding_layout_1">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="full">
        ...
        <div class="row">
            ...
            ?>
                <div class="col-sm-4">
                    <div class="full blog_colum" padding="0" max-width="350px">
                        <h3><a href="<?= base_url('berita/detail_berita/' . $s->id) ?>"><?php echo $s->judul ?></a></h3>
                        <div class="geeks">
                            <p><a href="<?= base_url('berita/detail_berita/' . $s->id) ?>"><img src=" <?php echo base_url('upload/berita/' . $s->foto); ?>" class="img img-responsive" width=" 300px" height=" 200px" border=" 4px" solid=" #575D63" alt="Geeks Image"></a></p>
                        </div>
                        <?php $string = $s->isi;
                        $string1 = character_limiter($string, 6);
                        ?>
                        <p><?php echo $string1 ?></p>
                        <?php echo anchor('berita/detail_berita/' . $s->id, '<div class="btn btn-sm btn-dark ">Selengkapnya</div>') ?>
                    </div>
                </div>
            ...
            <div class="col-lg text-center">
                ...
                <?php echo anchor('berita/index/' . $s->id, '<div class="btn btn-lg btn-info mt-5 mb-3">Info lengkap</div>') ?>
            </div>
        </div>
    </div>
</section>
