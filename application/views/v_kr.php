...
<!-- end header -->
  ...
  <div class="container">
    <div class="row">
      ...
      <i><font color="grey" size="2" face="Arial">Beranda > Kecantikan Rambut</font></i><br><br>
      <font color="black" size="6" face="Arial">Kecantikan Rambut</font><br><br>
        <div class="row">
          <div class="col-md-12 service_blog margin_bottom_50">
            <div class="full">
              <div class="service_img"> <img class="img-responsive" src="<?= base_url() ?>template/front-end/images/it_service/kr.png" alt="#" /> </div>
              <i><font color="grey" size="2" face="Arial">Kecantikan Rambut</font></i><br><br>
