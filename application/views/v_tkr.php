...
<!-- end header -->
  ...
  <div class="container">
    <div class="row">
      ...
      <i><font color="grey" size="2" face="Arial">Beranda > Teknik Kendaraan Ringan</font></i><br><br>
      <font color="black" size="6" face="Arial">Teknik Kendaraan Ringan</font><br><br>
        <div class="row">
          <div class="col-md-12 service_blog margin_bottom_50">
            <div class="full">
              <div class="service_img"> <img class="img-responsive" src="<?= base_url() ?>template/front-end/images/it_service/tkr.jpg" alt="#" /> </div>
