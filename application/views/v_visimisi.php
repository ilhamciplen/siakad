          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                ...
                <li><a class="active" href="#">Tentang Kami</a>
                <ul>
...
<!-- end header -->
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <i><font color="grey" size="2" face="Arial">Beranda > Visi Misi SMK Islam Al-Hikmah Mayong</font></i><br><br>
      <font color="black" size="6" face="Arial">Visi Misi SMK Islam Al-Hikmah Mayong</font><br><br><br><br>
        <div class="row">
